...
El constructor acepta argumentos, como mínimo un Self, que es el nombre del objeto cuando es necesario crear o construirlo.
...
class Para_Construir_objetos:
	...
	def __init__(self):#pasa por aquí el nombre del objeto
		'''Este es el constructor donde se estructura todo el objeto.
		Self es donde pasa el objeto'''
		self.ojos=2
		self.piernas=2
		self.pies=2
...
objeto_1.trabajar=True
print(f"\nposee las siguientes características:\n\t {str(objeto_1)}")
print(objeto_1.__doc__)
objeto_2=Para_Construir_objetos()
objeto_2.dormir=False
print(f"\nposee las siguientes características:\n\t {str(objeto_2)}")
print(objeto_2.__init__.__doc__)
...
class Constructor_Familia:
	...
	║        Clase Familia         ║
	╚══════════════════════════════╝
	Esto es una definición de la clases, puede ser un menú de los métodos de esta
	"""
	...
	def __init__(self,padre,madre,hijos=[]):
		...
		self.madre=madre
		self.hijos=hijos
	def tareas_familiares(self):
			"""
			╔══════════════════════════════╗
			║            Método            ║
			║      tareas_familiares       ║
			╚══════════════════════════════╝
			Esto es una definición del método de la clases, puede ser que parámetros necesita
			"""
			pass
	def __str__(self):#<--------------------------------__str__ estructurar una salida para poder hacer un informe muy fácilmente
		cadena="Padre:"+self.padre+","+"Madre:"+self.madre
		for hi in self.hijos:
			cadena=cadena+","+"Hijo:"+hi
		return cadena
familia0=Constructor_Familia("Jorge","Carla")
...
print(familia3)
print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
print(familia3.__doc__)#<--------------------------------------------------__doc__ estructurar la documentación de la clase
print(familia3.tareas_familiares.__doc__)#<--------------------------------__doc__ estructurar la documentación del método de la clase
"""
