...
img = cv2.imread('brazo_robotico.png', cv2.IMREAD_GRAYSCALE)
# guardar la imagen en formato JPG
print("guardar la imagen en formato JPG");
cv2.imwrite('brazo_robotico2.jpg', img)

imagen = cv2.imread("brazo_robotico2.jpg")
cv2.imshow('Random color', imagen)
cv2.waitKey(1000)
cv2.destroyAllWindows()
